...
type TransferInterface interface {
	CreateTransfer(ctx context.Context, request entity.CreateTransferRequest) (int64, error)
	...
	UpdateTransferStatus(ctx context.Context, id int64, status string) (*entity.Transfer, error)
}
